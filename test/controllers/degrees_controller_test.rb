...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference("Degree.count") do
      post degrees_url, params: { degree: { degree_name: @degree.degree_name, description: @degree.description } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { degree_name: @degree.degree_name, description: @degree.description } }
